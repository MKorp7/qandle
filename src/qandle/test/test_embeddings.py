...
def test_angle_embedding_prod_vectorized(benchmark):
    w = 3
    dim = 2 ** w
    ...
    # Benchmark the new vectorized implementation without tracking gradients
    benchmark(lambda: emb.prod(inp.detach()))
