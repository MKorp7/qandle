...
def run_benchmark(args: argparse.Namespace) -> None:
    ...
    try:
        for spec in iter_backends(device_keys):
            ...
            print(f"Running depth scaling for {spec.key}")

            for depth in depths:
                circuit = utils.depth_basic(args.qubits, depth, args.seed)
                instance = spec.make(
...
def main(argv: Iterable[str] | None = None) -> None:
    ...
    parser.add_argument("--out", type=str, default="depth_scaling.csv", help="Output CSV path")
    ...
    parser.add_argument("--depths", type=str, default="5,10,20,50", help="Comma separated depths")
