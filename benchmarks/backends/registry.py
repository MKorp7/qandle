...
def _qandle_factory(backend_name: str, device: str, variant: str) -> Factory:
...
register_backend(
    BackendSpec(
        ...
        factory=_qandle_factory("statevector", "cpu", variant="new"),
...
register_backend(
    BackendSpec(
        ...
        factory=_qandle_factory("statevector", "cuda", variant="new"),
...
register_backend(
    BackendSpec(
        ...
        factory=_qandle_factory("mps", "cpu", variant="new"),
...
register_backend(
    BackendSpec(
        key="qandle_old_sv_cpu",
        label="QANDLE Legacy (Statevector, CPU)",
        family="qandle",
        sim_type="statevector",
        hardware="CPU",
        features={
        ...
        factory=_qandle_factory("statevector", "cpu", variant="legacy"),
        availability=lambda: _check_qandle(new_backend=False),
    )
)
...
register_backend(
    BackendSpec(
        key="qandle_old_sv_gpu",
        label="QANDLE Legacy (Statevector, GPU)",
        family="qandle",
        sim_type="statevector",
        hardware="GPU",
        features={
        ...
        factory=_qandle_factory("statevector", "cuda", variant="legacy"),
        availability=lambda: (False, "CUDA backend unavailable")
        if not _torch_cuda_available()
        else _check_qandle(new_backend=False),
    )
)
...
register_backend(
    BackendSpec(
        key="qandle_old_mps_cpu",
        label="QANDLE Legacy (MPS, CPU)",
        family="qandle",
        sim_type="mps",
        hardware="CPU",
        features={
        ...
        factory=_qandle_factory("mps", "cpu", variant="legacy"),
        availability=lambda: _check_qandle(new_backend=False),
    )
)
